...
public class HTML {
    ...
    public static class Tag {
         ...
         * we create some fake tag types to mark the elements
    ...
    public static final class Attribute {
         ...
         * Attribute "name"
         */
        public static final Attribute NAME = new Attribute("name"); //NOSONAR
     ...
     *
     * @return the array of actual HTML tags that
     * are recognized by the default HTML reader
     */
    ...
    // size determined similar to the size of tagHashtable
    private static final HashMap<String, Attribute> attHashtable = HashMap.newHashMap(77);
     ...
     * @return the array of HTML attributes recognized
     */
    ...
    public static Attribute getAttributeKey(String attName) {
        return attHashtable.get(attName);
    }
